        ...
        <?php 
         ...
         ?><br>
            ...
            <div class="content">
                ...
                <form action="../../php/create_topics-engine.php" method="post">
                    <div>
                ...
                ?>
                    ...
                    <div>
                        <button type="submit" name="create-btn" class="btn btn-big">Add Topic</button>
                    </div>
                </form>
            </div>
